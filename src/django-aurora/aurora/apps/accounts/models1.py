...
class Profile(CreationModificationDateBase, MetaTagsBase):
	...
	bdate = models.DateField(default='07/09/1978', verbose_name=_("Birth date"))
...
class Patient(Profile):
	user = models.OneToOneField(User, on_delete=models.PROTECT, primary_key=True, verbose_name=_("Patient user"))
